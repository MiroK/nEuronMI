...
class Box(BaseShape):
    ...
    def __init__(self, minlim, maxlim):
        ...
        minlim = minlim * self.conversion_factor
        maxlim = maxlim * self.conversion_factor
...
class Sphere(BaseShape):
    ...
    def __init__(self, c, r):
        ...
        c = c * self.conversion_factor
        r = r * self.conversion_factor
...
class Cylinder(BaseShape):
    ...
    def __init__(self, A, B, r):
        ...
        A = A * self.conversion_factor
        B = B * self.conversion_factor
        r = r * self.conversion_factor
...
class Cone(BaseShape):
    ...
    def __init__(self, A, B, rA, rB):
        ...
        A = A * self.conversion_factor
        B = B * self.conversion_factor
        rA = rA * self.conversion_factor
        rB = rB * self.conversion_factor
