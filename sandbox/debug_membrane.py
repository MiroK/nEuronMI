...
class TestMembrane(unittest.TestCase):
    mesh_path = '../../mesh_bas_microwire_09-12-2019_17-17/mesh_bas_microwire_09-12-2019_17-17.h5'
    scale_factor = 1e-4
    # @classmethod
    # def setUpClass(cls):
        # not os.path.exists(TestMembrane.mesh_path) and subprocess.call(['python two_neurons.py'], cwd='./sandbox',
        #                                                                shell=True)
    ...
    def test_membrane(self):
        emi_map = '../../mesh_bas_microwire_09-12-2019_17-17/mesh_bas_microwire_09-12-2019_17-17.json'
...
def _membrane(mesh_path, emi_map, problem_parameters):
    ...
    for odes in neuron_solutions:
        ...
        if step_count == fem_ode_sync:
            ...
            print(p0_neuron.vector().norm('l2'))
